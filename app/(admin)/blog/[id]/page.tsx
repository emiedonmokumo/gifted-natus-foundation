  ...
  return (
    <>
      <Head>
        ...
        <link rel="shortcut icon" href="/.jpeg" type="image/x-icon" />
      ...
      <body>
        ...
        <main>
          <h1 className="text-4xl text-center font-gobold mt-[100px] my-11">
            {post?.title}
          </h1>
          {post && (
            <div
          ...
          <div className="mt-11">
            <div className="flex items-center justify-evenly">
              <h1 className="text-3xl">
                Other <span className="text-[#07a034]">ARTICLES</span>
              </h1>
              <div className="w-[30vh] h-[5px] bg-black"></div>
            </div>
            <RelatedPost />
          </div>
        </main>
