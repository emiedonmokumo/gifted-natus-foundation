  ...
  return (
    <div>
      ...
      <main>
        ...
        <div id="statement" className="mt-0 flex items-center space-y-52 justify-between flex-col md:h-auto lg:h-auto h-[calc(500px * 3)]">
          <div className="w-screen  flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="flex items-center lg:items-end h-80 justify-evenly flex-col p-10 lg:w-[60%]">
              ...
              <h2 className="font-bold text-center lg:text-right">Making a difference, Ever day</h2>
